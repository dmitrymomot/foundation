...
func (m *MockS3Client) PutObject(ctx context.Context, params *s3aws.PutObjectInput, optFns ...func(*s3aws.Options)) (*s3aws.PutObjectOutput, error) {
	args := m.Called(ctx, params, optFns)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*s3aws.PutObjectOutput), args.Error(1)
}

func (m *MockS3Client) HeadObject(ctx context.Context, params *s3aws.HeadObjectInput, optFns ...func(*s3aws.Options)) (*s3aws.HeadObjectOutput, error) {
	args := m.Called(ctx, params, optFns)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*s3aws.HeadObjectOutput), args.Error(1)
}

func (m *MockS3Client) ListObjectsV2(ctx context.Context, params *s3aws.ListObjectsV2Input, optFns ...func(*s3aws.Options)) (*s3aws.ListObjectsV2Output, error) {
	args := m.Called(ctx, params, optFns)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*s3aws.ListObjectsV2Output), args.Error(1)
}

func (m *MockS3Client) DeleteObject(ctx context.Context, params *s3aws.DeleteObjectInput, optFns ...func(*s3aws.Options)) (*s3aws.DeleteObjectOutput, error) {
	args := m.Called(ctx, params, optFns)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*s3aws.DeleteObjectOutput), args.Error(1)
}

func (m *MockS3Client) DeleteObjects(ctx context.Context, params *s3aws.DeleteObjectsInput, optFns ...func(*s3aws.Options)) (*s3aws.DeleteObjectsOutput, error) {
	args := m.Called(ctx, params, optFns)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*s3aws.DeleteObjectsOutput), args.Error(1)
}
...
func (m *MockS3ListObjectsV2Paginator) NextPage(ctx context.Context, optFns ...func(*s3aws.Options)) (*s3aws.ListObjectsV2Output, error) {
...
func TestNewS3Storage(t *testing.T) {
	...
	t.Run("valid config", func(t *testing.T) {
		...
		storage, err := s3.New(context.Background(), config)
	...
	t.Run("missing bucket", func(t *testing.T) {
		...
		s, err := s3.New(context.Background(), config)
		assert.Error(t, err)
		assert.True(t, errors.Is(err, storage.ErrInvalidConfig))
		assert.Nil(t, s)
	})
	...
	t.Run("with mock client", func(t *testing.T) {
		...
		opts := []s3.S3Option{
			s3.WithS3Client(mockClient),
		}

		storage, err := s3.New(context.Background(), config, opts...)
		require.NoError(t, err)
		require.NotNil(t, storage)
...
func TestS3Storage_Save(t *testing.T) {
	...
	t.Run("successful save", func(t *testing.T) {
		...
		mockClient.On("PutObject",
			...
			mock.MatchedBy(func(params *s3aws.PutObjectInput) bool {
		...
		storage, err := s3.New(context.Background(), s3.S3Config{
			Bucket: "test-bucket",
			Region: "us-east-1",
		}, s3.WithS3Client(mockClient))
		require.NoError(t, err)
	...
	t.Run("path traversal attempt", func(t *testing.T) {
		...
		s, err := s3.New(context.Background(), s3.S3Config{
			Bucket: "test-bucket",
			Region: "us-east-1",
		}, s3.WithS3Client(mockClient))
		require.NoError(t, err)
		...
		result, err := s.Save(context.Background(), fh, "../../../etc/passwd")
		assert.Error(t, err)
	...
	t.Run("nil file header", func(t *testing.T) {
		...
		result, err := s.Save(context.Background(), fh, "test.txt")
		assert.Error(t, err)
		assert.True(t, errors.Is(err, storage.ErrNilFileHeader))
		assert.Nil(t, result)
	})
...
func TestS3Storage_Delete(t *testing.T) {
	...
	t.Run("successful delete", func(t *testing.T) {
		...
		mockClient.On("HeadObject",
			mock.Anything, // context
			mock.MatchedBy(func(params *s3aws.HeadObjectInput) bool {
				return params.Bucket != nil && *params.Bucket == "test-bucket" &&
					params.Key != nil && *params.Key == "uploads/test.txt"
			}),
			mock.Anything, // optFns
		...
		mockClient.On("DeleteObject",
			mock.Anything, // context
			mock.MatchedBy(func(params *s3aws.DeleteObjectInput) bool {
				return params.Bucket != nil && *params.Bucket == "test-bucket" &&
					params.Key != nil && *params.Key == "uploads/test.txt"
			}),
			mock.Anything, // optFns
	...
	t.Run("file not found", func(t *testing.T) {
		...
		err = s.Delete(context.Background(), "uploads/notfound.txt")
		assert.Error(t, err)
...
func TestS3Storage_DeleteDir(t *testing.T) {
	...
	t.Run("successful delete", func(t *testing.T) {
		...
		mockClient.On("DeleteObjects",
			mock.Anything, // context
			mock.MatchedBy(func(params *s3aws.DeleteObjectsInput) bool {
				return params.Bucket != nil && *params.Bucket == "test-bucket" &&
					params.Delete != nil && len(params.Delete.Objects) == 2
			}),
			mock.Anything, // optFns
		).Return(&s3aws.DeleteObjectsOutput{}, nil)

		paginator := new(MockS3ListObjectsV2Paginator)
		paginator.On("HasMorePages").Return(true).Once()
		paginator.On("NextPage", mock.Anything, mock.Anything).Return(&s3aws.ListObjectsV2Output{
		...
		paginatorFactory := func(client s3.S3Client, params *s3aws.ListObjectsV2Input) s3.S3ListObjectsV2Paginator {
			return paginator
		}
		...
		storage, err := s3.New(context.Background(), s3.S3Config{
			Bucket: "test-bucket",
			Region: "us-east-1",
		}, s3.WithS3Client(mockClient), s3.WithPaginatorFactory(paginatorFactory))
		require.NoError(t, err)
	...
	t.Run("empty directory", func(t *testing.T) {
		...
		err = s.DeleteDir(context.Background(), "empty")
		assert.Error(t, err)
		assert.True(t, errors.Is(err, storage.ErrDirectoryNotFound))
	...
	t.Run("path traversal", func(t *testing.T) {
		...
		err = s.DeleteDir(context.Background(), "../../../etc")
		assert.Error(t, err)
		assert.True(t, errors.Is(err, storage.ErrInvalidPath))
	})
	...
	t.Run("paginated delete", func(t *testing.T) {
		...
		mockClient.On("DeleteObjects",
			...
			mock.Anything, // optFns
		).Return(&s3aws.DeleteObjectsOutput{}, nil).Times(2)
...
func TestS3Storage_List(t *testing.T) {
	...
	t.Run("list files and directories", func(t *testing.T) {
		...
		mockClient.On("ListObjectsV2",
			mock.Anything, // context
			mock.MatchedBy(func(params *s3aws.ListObjectsV2Input) bool {
				return params.Bucket != nil && *params.Bucket == "test-bucket" &&
					params.Prefix != nil && *params.Prefix == "uploads/" &&
					params.Delimiter != nil && *params.Delimiter == "/"
			}),
			mock.Anything, // optFns
		).Return(&s3aws.ListObjectsV2Output{
	...
	t.Run("empty directory", func(t *testing.T) {
		...
		mockClient.On("ListObjectsV2",
			...
			mock.Anything, // params
			mock.Anything, // optFns
		).Return(&s3aws.ListObjectsV2Output{}, nil)
	...
	t.Run("path traversal", func(t *testing.T) {
		...
		entries, err := s.List(context.Background(), "../../../etc")
		assert.Error(t, err)
		assert.True(t, errors.Is(err, storage.ErrInvalidPath))
		assert.Len(t, entries, 0)
	})
	...
	t.Run("root directory", func(t *testing.T) {
		...
		mockClient.On("ListObjectsV2",
			...
			Contents: []types.Object{
				{Key: aws.String("storage.txt"), Size: aws.Int64(50)},
			},
		}, nil)
...
func TestS3Storage_URL(t *testing.T) {
	...
	t.Run("default AWS URL", func(t *testing.T) {
		...
		storage, err := s3.New(context.Background(), config, s3.WithS3Client(new(MockS3Client)))
		require.NoError(t, err)
	...
	t.Run("AWS S3 path-style URL", func(t *testing.T) {
		t.Parallel()
		config := s3.S3Config{
			Bucket:         "my-bucket",
			Region:         "us-east-1",
		...
		url := storage.URL("uploads/image.jpg")
		assert.Equal(t, "https://s3.us-east-1.amazonaws.com/my-bucket/uploads/image.jpg", url)
	})
	...
	t.Run("custom endpoint virtual-hosted-style", func(t *testing.T) {
		t.Parallel()
		config := s3.S3Config{
			Bucket:         "my-bucket",
			Region:         "us-east-1",
		...
		url := storage.URL("uploads/image.jpg")
		assert.Equal(t, "https://my-bucket.s3.example.com/uploads/image.jpg", url)
	})
	...
	t.Run("custom base URL with trailing slash", func(t *testing.T) {
		...
		url := storage.URL("uploads/image.jpg")
		assert.Equal(t, "https://cdn.example.com/static/uploads/image.jpg", url)
	})
...
func TestS3Storage_ErrorClassification(t *testing.T) {
	...
	t.Run("AccessDenied error", func(t *testing.T) {
		...
		_, err = s.Save(ctx, fh, "test.txt")
		assert.Error(t, err)
		assert.True(t, errors.Is(err, storage.ErrAccessDenied))
	...
	t.Run("Context timeout", func(t *testing.T) {
		...
		s, err := s3.New(ctx, s3.S3Config{
			Bucket: "test-bucket",
			Region: "us-east-1",
		}, s3.WithS3Client(client), s3.WithS3UploadTimeout(10*time.Millisecond))
		require.NoError(t, err)

		fh := createFileHeader("test.txt", []byte("content"))
		_, err = s.Save(ctx, fh, "test.txt")
		assert.Error(t, err)
		assert.True(t, errors.Is(err, storage.ErrOperationTimeout))
...
func TestS3Storage_Integration(t *testing.T) {
	...
	mockClient.On("PutObject",
		...
		mock.Anything, // optFns
	).Return(&s3aws.PutObjectOutput{}, nil).Run(func(args mock.Arguments) {
	...
	mockClient.On("HeadObject",
		...
		mock.Anything, // optFns
	).Return(&s3aws.HeadObjectOutput{}, nil).Run(func(args mock.Arguments) {
	...
	mockClient.On("DeleteObject",
		...
		mock.Anything, // optFns
	).Return(&s3aws.DeleteObjectOutput{}, nil).Run(func(args mock.Arguments) {
