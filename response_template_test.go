...
func TestTemplate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			response := gokit.Template(tt.template, tt.data)
...
func TestTemplateWithStatus(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			response := gokit.TemplateWithStatus(tt.template, tt.data, tt.status)
			req := httptest.NewRequest("GET", "/", nil)
			w := httptest.NewRecorder()
...
func TestTemplateName(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			response := gokit.TemplateName(templates, tt.templateName, tt.data)
			req := httptest.NewRequest("GET", "/", nil)
			w := httptest.NewRecorder()
...
func TestTemplateNameWithStatus(t *testing.T) {
	...
	response := gokit.TemplateNameWithStatus(templates, "404.html", nil, http.StatusNotFound)
	req := httptest.NewRequest("GET", "/", nil)
	w := httptest.NewRecorder()
...
func TestTemplateStream(t *testing.T) {
	...
	response := gokit.TemplateStream(tmpl, data)
	req := httptest.NewRequest("GET", "/", nil)
	w := httptest.NewRecorder()
...
func TestTemplateStreamWithStatus(t *testing.T) {
	...
	response := gokit.TemplateStreamWithStatus(tmpl, nil, http.StatusAccepted)
	req := httptest.NewRequest("GET", "/", nil)
	w := httptest.NewRecorder()
...
func TestTemplate_NilTemplate(t *testing.T) {
	...
	assert.Nil(t, gokit.Template(nil, nil))
	assert.Nil(t, gokit.TemplateWithStatus(nil, nil, 200))
	assert.Nil(t, gokit.TemplateName(nil, "test", nil))
	assert.Nil(t, gokit.TemplateNameWithStatus(nil, "test", nil, 200))
	assert.Nil(t, gokit.TemplateStream(nil, nil))
	assert.Nil(t, gokit.TemplateStreamWithStatus(nil, nil, 200))
}
...
func TestTemplate_TemplateError(t *testing.T) {
	...
	response := gokit.Template(tmpl, data)
	req := httptest.NewRequest("GET", "/", nil)
	w := httptest.NewRecorder()
...
func TestTemplate_InvalidTemplateName(t *testing.T) {
	...
	response := gokit.TemplateName(templates, "nonexistent.html", nil)
	req := httptest.NewRequest("GET", "/", nil)
	w := httptest.NewRecorder()
...
func TestTemplate_BufferedVsStreaming(t *testing.T) {
	...
	t.Run("buffered_invalid_function", func(t *testing.T) {
		...
		response := gokit.Template(tmpl, map[string]any{"NotFunc": "value"})
		req := httptest.NewRequest("GET", "/", nil)
		w := httptest.NewRecorder()
	...
	t.Run("streaming_invalid_function", func(t *testing.T) {
		...
		response := gokit.TemplateStream(tmpl, map[string]any{"NotFunc": "value"})
		req := httptest.NewRequest("GET", "/", nil)
		w := httptest.NewRecorder()
...
func TestTemplate_LargeContent(t *testing.T) {
	...
	response := gokit.Template(tmpl, largeText)
	req := httptest.NewRequest("GET", "/", nil)
	w := httptest.NewRecorder()
