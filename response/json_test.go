...
func TestJSON(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			response := response.JSON(tt.value)
...
func TestJSONWithStatus(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			response := response.JSONWithStatus(tt.value, tt.statusCode)
			req := httptest.NewRequest("GET", "/", nil)
			w := httptest.NewRecorder()
...
func TestJSONWithCustomHeaders(t *testing.T) {
	...
	response := response.JSON(map[string]string{"message": "test"})
	req := httptest.NewRequest("GET", "/", nil)
	w := httptest.NewRecorder()
...
func TestJSONLargeData(t *testing.T) {
	...
	response := response.JSON(largeData)
	req := httptest.NewRequest("GET", "/", nil)
	w := httptest.NewRecorder()
