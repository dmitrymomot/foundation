...
func TestFile(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			response := response.File(tt.path)
...
func TestDownload(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			response := response.Download(tt.path, tt.filename)
			req := httptest.NewRequest("GET", "/", nil)
			w := httptest.NewRecorder()
...
func TestAttachment(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			response := response.Attachment(tt.data, tt.filename, tt.contentType)
			req := httptest.NewRequest("GET", "/", nil)
			w := httptest.NewRecorder()
...
func TestFileReader(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			response := response.FileReader(reader, tt.filename, tt.contentType)
			req := httptest.NewRequest("GET", "/", nil)
			w := httptest.NewRecorder()
...
func TestFileReaderWithReader(t *testing.T) {
	...
	response := response.FileReader(reader, "test.txt", "text/plain")
	req := httptest.NewRequest("GET", "/", nil)
	w := httptest.NewRecorder()
...
func TestCSV(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			response := response.CSV(tt.records, tt.filename)
			req := httptest.NewRequest("GET", "/", nil)
			w := httptest.NewRecorder()
...
func TestCSVWithHeaders(t *testing.T) {
	...
	response := response.CSVWithHeaders(headers, rows, "users")
	req := httptest.NewRequest("GET", "/", nil)
	w := httptest.NewRecorder()
...
func TestCSVWithEmptyData(t *testing.T) {
	...
	response := response.CSVWithHeaders(headers, rows, "empty_data")
	req := httptest.NewRequest("GET", "/", nil)
	w := httptest.NewRecorder()
