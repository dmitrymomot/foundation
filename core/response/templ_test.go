...
func TestTempl(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			response := response.Templ(tt.component)
...
func TestTemplWithStatus(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			response := response.TemplWithStatus(tt.component, tt.status)
			req := httptest.NewRequest("GET", "/", nil)
			w := httptest.NewRecorder()
...
func TestTempl_NilComponent(t *testing.T) {
	...
	// Test Templ with nil
	resp := response.Templ(nil)
	assert.Nil(t, resp)

	// Test TemplWithStatus with nil
	resp = response.TemplWithStatus(nil, http.StatusOK)
	assert.Nil(t, resp)
}
...
func TestTempl_ComponentError(t *testing.T) {
	...
	response := response.Templ(component)
	req := httptest.NewRequest("GET", "/", nil)
	w := httptest.NewRecorder()
...
<body>
	...
	response := response.Templ(pageComponent)
	req := httptest.NewRequest("GET", "/", nil)
	w := httptest.NewRecorder()
