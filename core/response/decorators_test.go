...
func TestWithHeaders(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			baseResp := response.String("test content")

			// Wrap with headers
			resp := response.WithHeaders(baseResp, tt.headers)
...
func TestWithCookie(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Wrap with cookie
			resp := response.WithCookie(baseResp, tt.cookie)
...
func TestWithCookie_Nil(t *testing.T) {
	...
	baseResp := response.String("test content")
	resp := response.WithCookie(baseResp, nil)
...
func TestWithCache(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Wrap with cache
			resp := response.WithCache(baseResp, tt.maxAge)
...
func TestWithHeaders_NilResponse(t *testing.T) {
	...
	resp := response.WithHeaders(nil, map[string]string{"X-Test": "value"})
	if resp != nil {
...
func TestWithCache_NilResponse(t *testing.T) {
	// Test with nil response
	resp := response.WithCache(nil, time.Hour)
	if resp != nil {
