...
func TestGetMIMEType(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := storage.GetMIMEType(fh)
			if tt.wantErr {
				assert.Error(t, err)
			} else {
...
func TestValidateSize(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := storage.ValidateSize(fh, tt.maxBytes)
			if tt.wantErr {
				assert.Error(t, err)
			} else {
...
func TestValidateMIMEType(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := storage.ValidateMIMEType(fh, tt.allowedTypes...)
			if tt.wantErr {
				assert.Error(t, err)
			} else {
				assert.NoError(t, err)
...
func TestHash(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := storage.Hash(fh, tt.hashFunc)
...
func TestSanitizeFilename(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			got := storage.SanitizeFilename(tt.filename)
			assert.Equal(t, tt.want, got)
		})
	}
}
